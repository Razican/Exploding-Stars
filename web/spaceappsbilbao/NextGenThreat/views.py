...
def credits(request):
	context = {'contributors': [
			...
			{'name': 'Alejandro', 'lastname': 'Pérez', 'description': 'Alejandro is a last year software engineering student, researcher in bioinformatics and net security and and cofounder of aprenditeka.'},
		],
	}
